...
class SyncController extends Controller
{
    public function fullSync(Request $request)
    {
        ...
        $payload = $request->validate([
            ...
            'events.*.location' => 'nullable',
            'events.*.start_at' => 'nullable',
            'events.*.end_at' => 'nullable',
            'events.*.capacity' => 'nullable',
            'events.*.is_all_day' => 'nullable',
            'events.*.is_public' => 'nullable',
            'events.*.created_at' => 'nullable',
            'events.*.updated_at' => 'nullable|string',
            'events.*.deleted_at' => 'nullable',

            'event_registrations' => 'array',
            'event_registrations.*.id' => 'required|integer',
            'event_registrations.*.event_id' => 'required',
            'event_registrations.*.user_id' => 'required',
            'event_registrations.*.status' => 'nullable',
            'event_registrations.*.presence_at' => 'nullable',
            'event_registrations.*.created_at' => 'nullable',
            'event_registrations.*.updated_at' => 'nullable|string',
            'event_registrations.*.deleted_at' => 'nullable',
